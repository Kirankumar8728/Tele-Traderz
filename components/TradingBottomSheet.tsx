    ...
    <AnimatePresence>
      <div className="fixed inset-0 bg-black/70 backdrop-blur-sm z-[140] flex items-end justify-center select-none">
        ...
        <motion.div
          ...
          className="w-full max-w-md bg-[#141922] border-t border-white/10 rounded-t-[2rem] p-4 pb-[env(safe-area-inset-bottom,24px)] max-h-[90vh] flex flex-col z-[150] shadow-[0_-8px_32px_rgba(0,0,0,0.5)]"
        >
