...
export const CashierHub: React.FC<CashierHubProps> = ({
  ...
  return (
    <div className="w-full px-2 sm:px-4 py-3 space-y-4 relative z-10 text-white animate-in fade-in duration-300">
      ...
      {/* OFFICIAL DERIV DIRECT EXTERNAL DEPOSIT BOX */}
      <div className="bg-gradient-to-r from-emerald-950/70 via-[#141922] to-blue-950/70 border border-emerald-500/40 hover:border-emerald-500/60 rounded-2xl p-4 sm:p-5 shadow-2xl flex flex-col md:flex-row items-start md:items-center justify-between gap-4 transition-all relative overflow-hidden group">
          ...
          <div>
            <div className="flex items-center gap-2 flex-wrap">
              <h3 className="text-sm sm:text-base font-black text-white uppercase tracking-wider flex items-center gap-2">
                Official Deriv External Direct Deposit
              </h3>
              <span className="px-2 py-0.5 rounded-md text-[10px] font-black uppercase tracking-wider bg-emerald-500/20 text-emerald-300 border border-emerald-500/30 flex items-center gap-1">
                <ShieldCheck className="w-3 h-3 text-emerald-400" />
                Verified Link
              </span>
            </div>
            <p className="text-xs text-gray-300 mt-1 max-w-2xl leading-relaxed">
              Fund your real account or Deriv Wallet directly via Deriv's hosted official cashier page with automated payment methods, cards, or crypto.
            </p>
            <div className="flex items-center gap-2 mt-2 font-mono text-[11px] text-emerald-400/90 bg-black/50 px-3 py-1 rounded-lg border border-white/10 w-fit">
              <Globe className="w-3.5 h-3.5 text-emerald-400 shrink-0" />
              <span className="truncate max-w-xs sm:max-w-md">https://home.deriv.com/dashboard/deposit?from=portfolio&currency=USD</span>
            </div>
          </div>
        </div>

        <div className="flex items-center gap-2 shrink-0 w-full md:w-auto justify-end relative z-10">
          <a
            href="https://home.deriv.com/dashboard/deposit?from=portfolio&currency=USD"
            target="_blank"
            rel="noopener noreferrer"
            className="w-full md:w-auto px-5 py-2.5 bg-emerald-500 hover:bg-emerald-600 text-black font-extrabold text-xs rounded-xl shadow-lg shadow-emerald-500/20 hover:shadow-emerald-500/30 transition-all flex items-center justify-center gap-2 hover:scale-[1.02] active:scale-[0.98]"
          >
            <span>Open External Deposit Portal</span>
            ...
            <div className="space-y-2">
              ...
              <div className="flex flex-wrap items-center gap-1.5 pt-0.5">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="px-2.5 py-1 bg-emerald-500/20 hover:bg-emerald-500/30 border border-emerald-500/40 rounded-lg text-emerald-200 text-[10px] font-black uppercase tracking-wider flex items-center gap-1.5 transition-all shadow-sm hover:scale-105 active:scale-95"
                  title="Official Deriv External Deposit Page"
                >
